<div
    ...
    x-init="items = JSON.parse('{{$items}}'); filterData();"
>
    <div class="border-b">
        <div class="w-full sm:w-8/12 mx-auto border-r border-l p-2 items-center gap-5 grid grid-cols-5">
                ...
                <template x-for="item in filteredItems" :key="item.id">
                    <div class="card col-span-1 flex rounded-md p-2 border items-center justify-start gap-2 relative">
                        ...
                        <div class="grid font-normal text-xs">
                            ...
                            <span>₾<span x-text="item.price" class="text-sm text-gray-950 font-medium"></span></span>
                        </div>
